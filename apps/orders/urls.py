...
urlpatterns = [
    ...
    path('panier/supprimer/<int:item_id>/', login_required(views.remove_from_cart_view), name='remove_from_cart'),
    ...
    path('commande/<int:order_id>/supprimer/', login_required(views.delete_order), name='delete_order'),
